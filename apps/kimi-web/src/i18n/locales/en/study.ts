export default {
  ...
  product: {
    ...
    libraryNavigation: 'Study library navigation',
    textbookLibrary: 'Textbook library',
    bookLibrary: 'Library',
    textbook: 'Textbook',
    book: 'Book',
    catalogHint: 'Choose a prepared source to create your own course. Your goal and lessons stay personal.',
    importPackage: 'Import prepared package',
    importInstalling: 'Checking and adding this material…',
    importSucceeded: 'Material added. It is ready to choose.',
    importInvalid: 'This file is not a valid prepared material package.',
    importTooLarge: 'This package is too large or expands beyond the safe limit.',
    importRightsDenied: 'This package does not grant the permissions needed for local study.',
    importIntegrityFailed: 'This package is incomplete or was changed after it was built.',
    importFailed: 'This material could not be added. Try the original package again.',
    emptyCatalog: 'No prepared materials here yet.',
    openCourse: 'Open course: {title}',
    openMaterial: 'View material: {title}',
