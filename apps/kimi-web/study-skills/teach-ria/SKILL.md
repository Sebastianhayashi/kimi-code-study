---
name: teach-ria
description: "[contract:teach-ria-v1] Read an uploaded textbook or nonfiction source in full, distill it through verified RIA++ method units while interviewing the learner's Mission, and build a source-faithful course. Use for Kimi Study deep mode, upgrades from quick mode, and certified preprocessed textbook packages."
---
...
- `lessons/*.html`, `reference/*.html`, `learning-records/*.md`, `RESOURCES.md`, `assets/*`, and `NOTES.md`.
...
7. update `publishedLessons` and publish incrementally in the Study snapshot.
