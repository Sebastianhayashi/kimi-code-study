...
def write_minimal_skill(root: Path, name: str = "teach-quick", revision: str = "teach-quick-v4") -> Path:
    skill = root / name
...
class SkillInstallerTest(unittest.TestCase):
    ...
    def test_recursive_skill_md_scan_only_current_skill(self) -> None:
        write_minimal_skill(self.destination, "teach-quick", "teach-quick-v4")
        ...
        source = write_minimal_skill(self.root / "src2", "teach-quick", "teach-quick-v4")
        ...
        self.assertIn("[contract:teach-quick-v4]", text)
    ...
    def test_install_replace_check_idempotent_loop(self) -> None:
        source = write_minimal_skill(self.root / "pack", "teach-quick", "teach-quick-v4")
